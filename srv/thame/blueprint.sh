...
install_hexcloud() {
    ...
    print_status "Starting Fresh Install for HexCloud Hosting"
    ...
    # --- Step 2: Install Yarn, Dependencies & HexCloud Hosting Release ---
    ...
    print_header "DOWNLOADING HEXCLOUD HOSTING"
    ...
    # --- Step 4: Run HexCloud Hosting Installer ---
...
reinstall_hexcloud() {
    print_header "REINSTALLING HEXCLOUD HOSTING"
...
# Function: Update HexCloud Hosting
update_hexcloud() {
    print_header "UPDATING HEXCLOUD HOSTING"
...
show_menu() {
    ...
    echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${CYAN}           🔧 BLUEPRINT INSTALLER               ${NC}"
    echo -e "${CYAN}              HexCloud Hosting                   ${NC}"
    echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e ""
    echo -e "${WHITE}╔═══════════════════════════════════════════════╗${NC}"
    ...
    echo -e "${WHITE}║   ${GREEN}3)${NC} ${CYAN}Update HexCloud Hosting${NC}                 ${WHITE}║${NC}"
