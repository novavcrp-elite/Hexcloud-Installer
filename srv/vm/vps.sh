...
EOF
    ...
    2)
        ...
        bash <(curl -s https://raw.githubusercontent.com/novavcrp-elite/Hexcloud-Installer/main/srv/vm/vm.sh)
    ...
    3)
        ...
        bash <(curl -s https://raw.githubusercontent.com/novavcrp-elite/Hexcloud-Installer/main/srv/vm/dd.sh)
        bash <(curl -s https://raw.githubusercontent.com/novavcrp-elite/Hexcloud-Installer/main/srv/vm/vm2.sh)
    ...
    4)
        ...
        bash <(curl -s https://raw.githubusercontent.com/novavcrp-elite/Hexcloud-Installer/main/srv/vm/proxmox.sh)
